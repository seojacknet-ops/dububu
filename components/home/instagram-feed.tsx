...
const fallbackPosts = [
    {
        id: 1,
        image: 'https://seojack.space/image-1225-b245f90a.webp',
        alt: 'Bubu and Dudu cute couple illustration',
    },
    {
        id: 2,
...
export function InstagramFeed() {
    ...
    return (
        <section className="py-20 bg-gradient-to-b from-white to-brand-soft-pink/30">
            <div className="container mx-auto px-4">
                <div className="mb-12 text-center">
                    <h2 className="mb-4 font-heading text-3xl font-bold text-brand-brown md:text-4xl">
                        Follow Us on Instagram 📸
                    </h2>
                    <p className="text-gray-600 mb-4">
                        Join our community of Bubu & Dudu lovers!
                    </p>
                    <Link 
                        href={INSTAGRAM_URL}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 text-brand-pink hover:text-brand-pink/80 font-semibold transition-colors"
                    >
                ...
                {/* Elfsight Instagram Feed Widget - Auto-updates with latest posts */}
                {ELFSIGHT_WIDGET_ID && mounted ? (
                    <>
                        <Script 
